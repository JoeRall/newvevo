...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //If user is logged in, take to player screen
        ...
        if(user.email !=  ""){
            initialViewController = storyboard.instantiateViewControllerWithIdentifier("movieViewController") as! UIViewController
